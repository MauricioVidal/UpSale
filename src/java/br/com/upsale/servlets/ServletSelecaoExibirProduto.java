 ...
 */
@WebServlet(name = "ServletSelecaoExibirProduto", urlPatterns = {"/selecao_exibir_produto"})
public class ServletSelecaoExibirProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect("./exibir_produto.jsp");
        } catch (Exception ex) {
            Logger.getLogger(ServletSelecaoExibirProduto.class.getName()).log(Level.SEVERE, null, ex);
